                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="resturant_id" id=""
                                                                    ...
                                                                    @foreach ($resturants as $rest)
                                                                        <option @selected($rest['id'] == $product['resturant_id'])
                                                                            value="{{ $rest['id'] }}">
                                                                            {{ $rest['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select required class="form-control" id="category_id"
                                                                ...
                                                                @foreach ($MainCategories as $maincat)
                                                                    <option @selected($maincat['id'] == $product['category_id'])
                                                                        value="{{ $maincat['id'] }}">
                                                                        {{ $maincat['name'] }}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="status" name="status">
                                                                ...
                                                                <option @selected($product->status == 1) value="1"
                                                                    selected> مفعل
                                                                </option>
                                                                <option @selected($product->status == 0) value="0"> ارشيف
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="is_featured" id="is_featured"
                                                                class="form-control">
                                                                <option @selected($product['is_featured'] == 0) value="0"
                                                                    selected> لا
                                                                </option>
                                                                <option @selected($product['is_featured'] == 1) value="1"> نعم
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="image" class="form-label"> صورة
                                                                المنتج </label>
                                                            <input type="file" id="single-image-edit"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="product_type" id="product-type"
                                                                class="form-control">
                                                                <option value="simple"
                                                                    @if ($product['product_type'] == 'simple') selected @endif>بسيط
                                                                </option>
                                                                <option value="variable"
                                                                    @if ($product['product_type'] == 'variable') selected @endif>
                                                                    متغير
                                                                </option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div id="simple-product-fields">
                                                            <div class="form-group">
                                                                ...
                                                                <input step="0.01" type="number" id="price"
                                                                    name="price" class="form-control" placeholder="" value="{{ $product['price'] }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
