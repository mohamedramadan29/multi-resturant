...
@section('title', ' تعديل منطقة الشحن  ')
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.shipping.index') }}"> مناطق الشحن
                                    </a>
                                </li>
                                <li class="breadcrumb-item active"><a href="#"> تعديل منطقة الشحن  </a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" method="POST"
                                            action="{{ route('dashboard.shipping.update', $shipping->id) }}') }}" autocomplete="off">
                                            @csrf
                                            <div class="form-body">
                                                <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="resturant_id" id=""
                                                                    ...
                                                                    @foreach ($resturants as $rest)
                                                                        <option @selected($rest['id'] == $category['resturant_id'])
                                                                            value="{{ $rest['id'] }}">
                                                                            {{ $rest['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="number" id="price"
                                                                ...
                                                                step="0.01" value="{{ old('price',$shipping->price) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
